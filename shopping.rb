...
# this is our remove function for clearing our list
def remove_item(list)
  quitrun = 1
  while quitrun == 1
    puts
    puts
    puts "ohh you made a mistake, okay no worries"
    puts "What do you want to remove?       type stop when you're done"
    rm_item = gets.chomp.capitalize

    case rm_item
    when "stop"
      quitrun == 2
    else
    list.each.delete_if {|x| x == rm_item}
    end
  end
end
